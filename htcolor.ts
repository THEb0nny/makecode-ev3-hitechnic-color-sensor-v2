...
namespace sensors {
    ...
    */
    ...
    export class HiTechnicColorSensor extends sensors.internal.IICSensor {
         ...
         */
        //% help=github:makecode-ev3-hitechnic-color-sensor-v2/docs/reference/sensors/ht-color-sensor-v2/mode
         ...
         * @param sensor the ht color sensor v2 port
         */
        //% help=github:makecode-ev3-hitechnic-color-sensor-v2/docs/reference/sensors/ht-color-sensor-v2/color
         ...
         * @param sensor the ht color sensor v2 port
         */
        //% help=github:makecode-ev3-hitechnic-color-sensor-v2/docs/reference/sensors/ht-color-sensor-v2/rgbw
         ...
         * @param sensor the ht color sensor v2 port
         */
        //% help=github:makecode-ev3-hitechnic-color-sensor-v2/docs/reference/sensors/ht-color-sensor-v2/passive-rgbw
         ...
         * @param sensor the ht color sensor v2 port
         */
        //% help=github:makecode-ev3-hitechnic-color-sensor-v2/docs/reference/sensors/ht-color-sensor-v2/raw-rgbw
         ...
         * @param sensor the ht color sensor v2 port
         */
        //% help=github:makecode-ev3-hitechnic-color-sensor-v2/docs/reference/sensors/ht-color-sensor-v2/hsvl
         ...
         */
        //% help=github:makecode-ev3-hitechnic-color-sensor-v2/docs/reference/sensors/ht-color-sensor-v2/frequency
